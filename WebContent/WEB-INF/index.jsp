...
<br>
	...
	<tr>
				 <td width="450px" align="center"><img alt="Mozilla" src="WebContent/WEB-INF/images/image1.png" style="width:50px;height:50px;"></td>
 <td width="450px" align="center"> <img alt="Chrome" src="WebContent/WEB-INF/images/image2.jpeg" style="width:50px;height:50px;"></td>
  <td width="450px" align="center"><img  src="WebContent/WEB-INF/images/image3.jpeg" alt="IE" style="width:50px;height:50px;"></td>
	<tr>
	 <td width="450px" align="center"><input type="radio" name="browser" value="Mozilla" checked="checked" > Mozilla</td>
 <td width="450px" align="center"> <input type="radio" name="browser" value="IE" width="300px"> IE</td>
  <td width="450px" align="center"><input type="radio" name="browser" value="Chrome" width="300px"> Chrome</td>
  </tr>
</table>
<table class="testCaseTable" border="1 px" align="center" cellpadding="3px">
<tr id="table-head">
	
	<td class="testCase__content" width="300px" align="center" style="font-weight: bold;">TEST CASE ID</td>
	<td class="testCase__content" width="300px" align="center" style="font-weight: bold;">TEST CASE</td>
	<td class="testCase__content" width="300px" align="center" style="font-weight: bold;">KEY WORD</td>
	<td class="testCase__content" width="300px" align="center" style="font-weight: bold;">TEST STATUS</td>
...
<br>
<br>
<center><input type="submit" value="Submit" id="testrun" width="50px" height="20px" /></center>
<center>${message}
</form>
